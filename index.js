...
client.once("ready", async () => {
    ...
    // Cron job kiểm tra và đồng bộ ẩn/hiện profile lúc 1:00 AM hàng ngày
    ...
    cron.schedule("0 0 * * *", async () => {
        ...
        for (const [guildId] of guilds) {
            ...
            // 1. Quét gửi thông báo chúc mừng sinh nhật
...
// KIỂM TRA ROLE SỰ KIỆN ĐỂ CẬP NHẬT TRẠNG THÁI SẢNH DANH VỌNG
...
client.on("interactionCreate", async interaction => {
    if (interaction.isChatInputCommand()) {
        ...
        // Chạy lệnh ẩn danh công khai độc lập
        ...
        // TRA CỨU SINH NHẬT CÁ NHÂN (MỌI KÊNH)
